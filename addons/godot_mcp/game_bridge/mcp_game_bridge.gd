...
func _handle_get_debug_output(_data: Array) -> void:
	# Logger disabled - return empty output
	EngineDebugger.send_message("godot_mcp:debug_output_result", [PackedStringArray()])
